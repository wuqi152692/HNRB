...
public class CommentReplyListActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        adapter = new CommentReplyListAdapter(this, content_id, String.valueOf(id));
    ...
    protected void initData() {
        GetCommentsMoreReq req = new GetCommentsMoreReq();
        req.id = id;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.pinglunLayout:
                ...
                NewsCommentDialog dialog = NewsCommentDialog.newInstance(content_id, "", NewsCommentDialog.NEWS_COMMENT, adapter != null && adapter.getItemCount() > 0 ? adapter.getItem(0).username : "");
