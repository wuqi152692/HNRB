...
package com.hnzx.hnrb.twocode.view;
...
public final class ViewfinderView extends View {
	...
	*/
	 ...
	 * 四个蓝色边角对应的宽度
	 */
	private static final int CORNER_WIDTH = 6;// 16
	/**
	 * 扫描框中的中间线的宽度
	 */
	private static final int MIDDLE_LINE_WIDTH = 3;// 6
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
		    ...
		    canvas.drawText(getResources().getString(R.string.msg_default_status), frame.centerX(), frame.bottom + TEXT_PADDING_TOP * density, paint);
