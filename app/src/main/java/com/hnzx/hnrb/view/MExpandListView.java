...
public class MExpandListView extends ExpandableListView {
    ...
    private View mCurrentStickyView, headerView;
    ...
    public MExpandListView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mStickyViews = new LinkedList<View>();
    }

    public void addMHeaderView(View header) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && headerView != null) {
            findViewByStickyTag((ViewGroup) headerView);
        }
        showStickyView();
    }
