...
import com.hnzx.hnrb.view.photopicker.adapter.PhotoPagerAdapter;
...
public class ImagePagerFragment extends Fragment {
    ...
    public static ImagePagerFragment newInstance(List<String> paths, int currentItem, int[] screenLocation, int thumbnailWidth,
                                                 int thumbnailHeight) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            paths.clear();
            if (pathArr != null) paths = new ArrayList<>(Arrays.asList(pathArr));
    ...
    private void runEnterAnimation() {
        ...
        ViewCompat.setPivotX(mViewPager, 0);
        ViewCompat.setPivotY(mViewPager, 0);
        ViewCompat.setScaleX(mViewPager, (float) thumbnailWidth / mViewPager.getWidth());
        ViewCompat.setScaleY(mViewPager, (float) thumbnailHeight / mViewPager.getHeight());
        ViewCompat.setTranslationX(mViewPager, thumbnailLeft);
        ViewCompat.setTranslationY(mViewPager, thumbnailTop);
