package com.hnzx.hnrb.view.banner;
...
/**
 * Created by mingancai on 2016-08-05 at 10:17 AM.
 */
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.red_radius;
    private int mIndicatorUnselectedResId = R.drawable.gray_radius;
    private int defaultImage = R.drawable.bg_morentu_datumoshi;
    private int count;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.red_radius);
    ...
    public void setBannerTitle(String[] titles) {
        ...
        if (bannerStyle == BannerConfig.CIRCLE_INDICATOR_TITLE ||
            ...
            if (titles != null && titles.length > 0) {
                ...
                numIndicator.setBackgroundResource(mIndicatorSelectedResId);
            }
        }
    }
    ...
    private void setImageArray(Object[] imagesUrl, OnLoadImageListener imageListener) {
        ...
        createIndicator();
        imageViews.clear();
        for (int i = 0; i <= (count < 2 ? 0 : count + 1); i++) {
