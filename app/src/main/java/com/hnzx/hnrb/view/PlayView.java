...
public class PlayView extends View {
    ...
    private void initColor(AttributeSet attrs) {
        for (int i = 0; i < 3; i++) {
            paintColor = "Background" == attrs.getAttributeValue(i) ? attrs.getAttributeValue(i) : "#ff763a";
            canvasColor = "ColColor" == attrs.getAttributeValue(i) ? attrs.getAttributeValue(i) : "#ffffff";
        }
    }
