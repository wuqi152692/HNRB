...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    // 开始结束动作回调接口
    private StartEndRefreshListener seListener;
    // 刷新成功
    ...
    // 刷新结果：成功或失败
    private TextView refreshStateCustomFontTextView;
    ...
    // 加载结果：成功或失败
    private TextView loadStateCustomFontTextView;
    ...
    Handler updateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (pullDownY < 0) {
                ...
                requestLayout();
                if (seListener != null)
                    seListener.endRefresh(PullToRefreshLayout.this);
            }
            if (pullUpY > 0) {
                // 已完成回弹
                pullUpY = 0;
    ...
    public void setStartEndRefreshListener(StartEndRefreshListener listener) {
        seListener = listener;
    }
    ...
    private void initView(Context context) {
        ...
        bottomOut = AnimationUtils.loadAnimation(context, R.anim.back_exit);
        bottomOut.setAnimationListener(new AnimationListener() {
        ...
        if (refreshingView != null) {
            ...
            switch (refreshResult) {
                case SUCCEED:
                    ...
                    refreshStateCustomFontTextView.setText(R.string.refresh_succeed);
                ...
                default:
                    // 刷新失败
                    refreshStateImageView.setVisibility(View.VISIBLE);
                    refreshStateCustomFontTextView.setText(R.string.refresh_fail);
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateCustomFontTextView.setText(R.string.load_succeed);
                loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
                break;
            case FAIL:
                // 加载失败
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateCustomFontTextView.setText(R.string.load_fail);
                loadStateImageView.setBackgroundResource(R.drawable.load_failed);
                break;
            default:
                //没有更多内容
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateCustomFontTextView.setText(R.string.load_nomore);
                loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
                break;
        }
        if (pullUpY < 0) {
            ...
            new Handler() {
                ...
                public void handleMessage(Message msg) {
                    ...
                    pullUpView.startAnimation(bottomOut);
                }
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                refreshStateCustomFontTextView.setText(R.string.pull_to_refresh);
                pullView.clearAnimation();
                pullView.setVisibility(View.VISIBLE);
                // 上拉布局初始状态
                loadStateImageView.setVisibility(View.GONE);
                loadStateCustomFontTextView.setText(R.string.pullup_to_load);
                pullUpView.clearAnimation();
                pullUpView.setVisibility(View.VISIBLE);
                break;
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateCustomFontTextView.setText(R.string.release_to_refresh);
            ...
            case REFRESHING:
                ...
                refreshStateCustomFontTextView.setText(R.string.refreshing);
                break;
            case RELEASE_TO_LOAD:
                // 释放加载状态
                loadStateCustomFontTextView.setText(R.string.release_to_load);
            ...
            case LOADING:
                ...
                loadStateCustomFontTextView.setText(R.string.loading);
                break;
            case DONE:
                // 刷新或加载完毕，啥都不做
                break;
            ...
            case MotionEvent.ACTION_MOVE:
                if (mEvents == 0) {
                    if (pullDownY > 0 || (((Pullable) pullableView).canPullDown() && canPullDown && state != LOADING)) {
                        ...
                        if (pullDownY < 0 || Math.abs(downX - ev.getX()) > Math.abs(downY - ev.getY())) {
                            pullDownY = 0;
                            canPullDown = false;
                            canPullUp = true;
                            if (seListener != null)
                ...
                requestLayout();
                if (pullDownY > 0) {
                    if (pullDownY >= refreshDist / 4 && pullDownY <= refreshDist)
                        if (seListener != null)
                            seListener.startRefresh(this);
    ...
    private void initView() {
        ...
        refreshStateCustomFontTextView = (TextView) refreshView.findViewById(R.id.state_tv);
        refreshingView = refreshView.findViewById(R.id.refreshing_icon);
        refreshStateImageView = refreshView.findViewById(R.id.state_iv);
        // 初始化上拉布局
        pullUpView = loadmoreView.findViewById(R.id.pullup_icon);
        loadStateCustomFontTextView = (TextView) loadmoreView.findViewById(R.id.loadstate_tv);
     ...
     * @author mingancai
     */
    public interface StartEndRefreshListener {

        void startRefresh(PullToRefreshLayout pullToRefreshLayout);

        void endRefresh(PullToRefreshLayout pullToRefreshLayout);
    }
}
