...
public class TopicCommentReplyListAdapter extends BaseAdapter<GetTopicCommentMoreRsp> {
    private String content_id;
    private String quoted;

    public TopicCommentReplyListAdapter(Context context, String content_id, String quoted) {
        super(context);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        mHolder.reply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != 0)
                    mContext.startActivity(TopicCommentActivity.newIntent(mContext, content_id, quoted, String.valueOf(rsp0.comment_id)));
                else
                    mContext.startActivity(TopicCommentActivity.newIntent(mContext, content_id, quoted));
            }
        });
    }
