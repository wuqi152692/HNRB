...
import com.hnzx.hnrb.ui.live.LiveDiscussReplyListActivity;
...
public class LiveCommentAdapter extends BaseAdapter<String> {
    private Map<String, CommentsBean> datas;
    private String content_id;

    public LiveCommentAdapter(Context context, String content_id) {
        super(context);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (containsReplace) {
            ...
            mHolder.replaceMsg.setText(replaceMsg.toString());
            ...
            if (totalRepalce > 0) {
                ...
                mHolder.replaceLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mContext.startActivity(LiveDiscussReplyListActivity.newIntent(mContext, content_id, rsp0.comment_id));
                    }
                });
            }
