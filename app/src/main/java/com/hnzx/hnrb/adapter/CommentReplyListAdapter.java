...
public class CommentReplyListAdapter extends BaseAdapter<GetTopicCommentMoreRsp> {
    private String content_id;
    private String quoted;

    public CommentReplyListAdapter(Context context, String content_id, String quoted) {
        super(context);
