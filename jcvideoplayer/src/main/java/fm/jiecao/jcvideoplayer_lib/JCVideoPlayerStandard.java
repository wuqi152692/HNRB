...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void init(Context context) {
        ...
        loadingProgressBar = (ProgressBar) findViewById(R.id.jc_loading);
    ...
    public void setUiWitStateAndScreen(int state) {
        ...
        Log.d("setUiWitStateAndScreen", "state: "+state);
        Log.d("setUiWitStateAndScreen", "currentState: "+currentState);
        switch (currentState) {
