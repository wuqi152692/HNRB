...
//                    hide();
    ...
    public MediaController(Context context, View layout) {
        super(context);
        this.layout = layout;
...
//        return ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("mediacontroller", "layout", mContext.getPackageName()), this);
    ...
    private void initControllerView(View v) {
        mPauseButton = (CheckBox) v.findViewById(getResources().getIdentifier("mediacontroller_play_pause", "id", mContext.getPackageName()));
        ...
        thumbImageView = v.findViewById(getResources().getIdentifier("thumbImageView", "id", mContext.getPackageName()));
        show();
    }
...
//            hide();
    ...
    private void updatePausePlay() {
        if (mRoot == null || mPauseButton == null)
            return;
        mHandler.sendMessageDelayed(mHandler.obtainMessage(FADE_OUT), 100000);
    }
